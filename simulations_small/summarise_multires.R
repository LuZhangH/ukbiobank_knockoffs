...
Selections %>% filter(Resolution=="Radj2", Fold=="01") %>%
...
out.file <- sprintf("%s/simulations_small/summary/knockoffs_%s_distinct_multires_c%s.txt",
...
out.file <- sprintf("%s/simulations_small/summary/knockoffs_%s_distinct_consolidated_multires_c%s.txt",
                    scratch, experiment.name, conservative)
...
out.file <- sprintf("%s/simulations_small/summary/knockoffs_%s_loci_multires_c%s.txt",
                    scratch, experiment.name, conservative)
