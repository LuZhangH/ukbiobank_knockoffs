...
# Parameters
CHR_LIST=$(seq 2 2)
CLUMPING_LIST=("Radj2") # "Radj5" "Radj10" "Radj20" "Radj50") # "Radj2" "Radj5" "Radj10" "Radj20" "Radj50"
PHENOTYPE_LIST=("rd") # "hypothyroidism" "cvd" "rd"
REGRESSION="logistic" # "linear" or "logistic"
...
for CLUMPING in "${CLUMPING_LIST[@]}"; do
  for PHENOTYPE in "${PHENOTYPE_LIST[@]}"; do
    for CHR in $CHR_LIST; do
      # Script to be run
      SCRIPT="marginal.sh -c $CHR -m $CLUMPING -k 50 -p $PHENOTYPE -r $REGRESSION"
