...
# Input
PHENO_DIR="/scratch/PI/candes/ukbiobank_tmp/simulations/phenotypes"

# Output
STATS_DIR="/scratch/PI/candes/ukbiobank_tmp/simulations/bolt_screen"
...
if [ $RUN_LASSO -eq 1 ]; then
  ...
  echo "----------------------------------------------------------------------------------------------------"
  echo ""
  LASSO_DIR="/scratch/PI/candes/ukbiobank_tmp/simulations/lasso"
  mkdir -p $LASSO_DIR
